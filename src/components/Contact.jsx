                ...
                <form action="" method="POST" className="space-y-8">
                    <div>
                        ...
                        <input
                            ...
                            id="email"
                            name="email"
                            className="shadow-sm bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-agshadowblack border-black border-solid border-1  dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            className="block w-full p-3 text-sm text-gray-900 border border-black border-solid rounded-lg shadow-sm bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-agshadowblack border-1 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="name"
                            required
                        />
                    </div>
                    <div className="sm:col-span-2">
                        ...
                        <textarea
                            ...
                            name="message"
                            rows="6"
                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border  focus:ring-primary-500 focus:border-primary-500 dark:bg-agshadowblack border-black border-solid border-1  dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 resize-none"
