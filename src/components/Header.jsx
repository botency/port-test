...
import HamburgerDark from "./element-components/HamburgerDark";
            ...
            <nav className="flex items-center justify-between p-6">
                ...
                <div className="">
                    <div className="hidden md:block">
                        <Link to={"/"} className="mr-5 md:inline-block">
                        ...
                        <a
                            href="./Resume.pdf"
                            download={true}
                            className="mr-5 md:inline-block"
                        >
                            <Button buttonText="my-resume" />
                        </a>
                        <Link to={"/contact"} className="mr-5 md:inline-block">
